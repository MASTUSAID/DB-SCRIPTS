...
ALTER TABLE public.la_spatialunit_land ADD COLUMN udparcelno character varying(50);ALTER TABLE public.la_spatialunitgroup_hierarchy ADD COLUMN code character varying(20);
Also update code in la_spatialunitgroup_hierarchy table.
CREATE SEQUENCE public.la_transactionhistory_seq  INCREMENT 1  MINVALUE 1  MAXVALUE 9223372036854775807  START 1  CACHE 1;
CREATE TABLE public.la_ext_transactionhistory(  transactionhistoryid integer NOT NULL DEFAULT nextval('la_transactionhistory_seq'::regclass),  oldownerid bigint,  newownerid bigint,   landid bigint,  transactionid integer,  isactive boolean NOT NULL DEFAULT true,  createdby integer NOT NULL,  createddate timestamp without time zone NOT NULL,  modifiedby integer,  modifieddate timestamp without time zone)
ALTER TABLE la_lease  ALTER COLUMN leaseyear DROP NOT NULL; ALTER TABLE la_lease  ALTER COLUMN monthid DROP NOT NULL;ALTER TABLE la_lease  ALTER COLUMN leaseamount DROP NOT NULL;
INSERT INTO public.la_ext_attributemaster(fieldname, fieldaliasname,datatypemasterid,attributecategoryid, referencetable, size, mandatory, listing,isactive, masterattribute)VALUES ('Institution Type','Institution Type', 5,5,'la_party_organization', 10, '1', true,true,true);
INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Civic',1154,1);INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Church',1154,7);INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Mosque',1154,2);INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Association (legal)',1154,3);INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Cooperative',1154,4);INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Informal Association (non-legal)',1154,5);INSERT INTO public.la_ext_attributeoptions(optiontext, attributemasterid, parentid) VALUES ( 'Other',1154,6);
Update public.la_ext_attributemaster Set listing='1' where attributemasterid=1154Update public.la_ext_attributemaster Set listing='2' where attributemasterid=6Update public.la_ext_attributemaster Set listing='3' where attributemasterid=1136Update public.la_ext_attributemaster Set listing='4' where attributemasterid=1138Update public.la_ext_attributemaster Set listing='5' where attributemasterid=1137Update public.la_ext_attributemaster Set listing='6' where attributemasterid=7Update public.la_ext_attributemaster Set listing='7' where attributemasterid=8
INSERT INTO public.la_ext_surveyprojectattributes(projectnameid,attributemasterid,attributecategoryid, attributeorder, isactive, createdby,createddate, modifiedby, modifieddate) VALUES (2, 1154,5, 1, true, 1, '2018-01-04 00:00:00', 1, '2018-01-04 00:00:00');
------------------------------------------------------
INSERT INTO la_ext_process VALUES (8, 'Parcel Split', 'Parcel Split', true);
Update la_ext_attributemaster set fieldaliasname ='Identification Type',fieldname='Identification Type' where attributemasterid =1152Update la_right_landsharetype set isactive =FALSE where landsharetypeid =9999Update la_baunit_landusetype set isactive =FALSE where landusetypeid =9999Update la_right_tenureclass set isactive =FALSE where tenureclassid =9999update la_baunit_landtype set isactive='false' where landtypeid= 9999;Insert into la_right_acquisitiontype(acquisitiontype,acquisitiontype_en,isActive)Values('Allocated by Family','Allocated by Family',true)Update la_right_acquisitiontype Set acquisitiontype='Allocated by community',acquisitiontype_en='Allocated by community' where acquisitiontypeid=1Update la_right_acquisitiontype Set acquisitiontype='Allocated by Family',acquisitiontype_en='Allocated by Family' where acquisitiontypeid=2Update la_right_acquisitiontype Set acquisitiontype='Gift',acquisitiontype_en='Gift' where acquisitiontypeid=3Update la_right_acquisitiontype Set acquisitiontype='Inheritance',acquisitiontype_en='Inheritance' where acquisitiontypeid=4Update la_right_acquisitiontype Set acquisitiontype='Purchase',acquisitiontype_en='Purchase' where acquisitiontypeid=5
Insert into la_ext_attributemaster(fieldname,fieldaliasname,datatypemasterid,attributecategoryid,referencetable,size,mandatory,listing,isactive,masterattribute) values('Disputed PersonType','Disputed PersonType',5,2,'la_party_person',100,'true',16,'true','true');
Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid) values('Owner',1155, 1);Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid) values('Disputed Person',1155, 2);
Insert into la_ext_surveyprojectattributes(projectnameid,attributemasterid,attributecategoryid,attributeorder,isactive,createdby,createddate,modifiedby,modifieddate)values(2,1155,2,14,'true',1,'2018-01-24 00:00:00',1,'2018-01-24 00:00:00');
------------------------------------------------------
update la_ext_attributemaster set fieldaliasname ='Identification No', fieldname='Identification No' where attributemasterid =1153
alter table la_lease add column leasestartdate timestampalter table la_lease add column leaseenddate timestampalter table la_surrenderlease add column leasestartdate timestampalter table la_surrenderlease add column leaseenddate timestampUpdate la_ext_attributemaster set fieldaliasname ='Disputed PersonType',fieldname='Disputed PersonType' where attributemasterid =1155
update la_partygroup_occupation set occupation ='Agriculture' , occupation_en='Agriculture' where occupationid=1update la_partygroup_occupation set occupation ='Livestock/Pastoralist' , occupation_en='Livestock/Pastoralist' where occupationid=2update la_partygroup_occupation set occupation ='Small Business' , occupation_en='Small Business' where occupationid=3update la_partygroup_occupation set occupation ='Skilled Labor (carpentry, masonry, etc)' , occupation_en='Skilled Labor (carpentry, masonry, etc)' where occupationid=4update la_partygroup_occupation set occupation ='Professional/administrative/office' , occupation_en='Professional/administrative/office' where occupationid=5update la_partygroup_occupation set occupation ='Public employee' , occupation_en='Public employee' where occupationid=6update la_partygroup_occupation set occupation ='Homekeeper' , occupation_en='Homekeeper' where occupationid=7update la_partygroup_occupation set occupation ='Other' , occupation_en='Other' where occupationid=8 INSERT INTO la_partygroup_persontype VALUES (11, 'Buyer', 'Buyer', true);
update la_ext_financialagency set financialagency='Bank', financialagency_en='Bank' where financialagencyid=1update la_ext_financialagency set financialagency='Rural Finance Institution', financialagency_en='Rural Finance Institution' where financialagencyid=2update la_ext_financialagency set financialagency='Mirco-Finance', financialagency_en='Mirco-Finance' where financialagencyid=3;
update la_partygroup_relationshiptype set relationshiptype='Spouses', relationshiptype_en='Spouses' where relationshiptypeid=1;update la_partygroup_relationshiptype set relationshiptype='Son', relationshiptype_en='Son' where relationshiptypeid=2;update la_partygroup_relationshiptype set relationshiptype='Daughter', relationshiptype_en='Daughter' where relationshiptypeid=3;update la_partygroup_relationshiptype set relationshiptype='Grandson', relationshiptype_en='Grandson' where relationshiptypeid=4;update la_partygroup_relationshiptype set relationshiptype='Granddaughter', relationshiptype_en='Granddaughter' where relationshiptypeid=5;update la_partygroup_relationshiptype set relationshiptype='Brother', relationshiptype_en='Brother' where relationshiptypeid=6;update la_partygroup_relationshiptype set relationshiptype='Sister', relationshiptype_en='Sister' where relationshiptypeid=7;update la_partygroup_relationshiptype set relationshiptype='Father', relationshiptype_en='Father' where relationshiptypeid=8;update la_partygroup_relationshiptype set relationshiptype='Mother', relationshiptype_en='Mother' where relationshiptypeid=9;update la_partygroup_relationshiptype set relationshiptype='Grandmother', relationshiptype_en='Grandmother' where relationshiptypeid=10;update la_partygroup_relationshiptype set relationshiptype='Grandfather', relationshiptype_en='Grandfather' where relationshiptypeid=11;update la_partygroup_relationshiptype set relationshiptype='Aunt', relationshiptype_en='Aunt' where relationshiptypeid=12;update la_partygroup_relationshiptype set relationshiptype='Uncle', relationshiptype_en='Uncle' where relationshiptypeid=13;update la_partygroup_relationshiptype set relationshiptype='Niece', relationshiptype_en='Niece' where relationshiptypeid=14;update la_partygroup_relationshiptype set relationshiptype='Nephew', relationshiptype_en='Nephew' where relationshiptypeid=15;update la_partygroup_relationshiptype set relationshiptype='Other', relationshiptype_en='Other' where relationshiptypeid=16;update la_partygroup_relationshiptype set relationshiptype='Other relatives', relationshiptype_en='Other relatives' where relationshiptypeid=17;update la_partygroup_relationshiptype set relationshiptype='Partners', relationshiptype_en='Partners' where relationshiptypeid=18;update la_partygroup_relationshiptype set relationshiptype='Parents and children', relationshiptype_en='Parents and children' where relationshiptypeid=19;update la_partygroup_relationshiptype set relationshiptype='Siblings', relationshiptype_en='Siblings' where relationshiptypeid=20;
update la_partygroup_gender set isactive=false where genderid=3
ALTER TABLE la_surrenderlease ADD COLUMN surrenderreason character varying(250);
Update date column startleasedate and endleasedate in Lease table from Timestamp to Date
update la_ext_attributeoptions set optiontext='Agriculture' where attributeoptionsid= 1149update la_ext_attributeoptions set optiontext='Livestock/Pastoralist' where attributeoptionsid= 1150
update la_partygroup_relationshiptype set relationshiptype='Spouse',relationshiptype_en='Spouse' where relationshiptypeid= 1update la_partygroup_relationshiptype set relationshiptype='Associate',relationshiptype_en='Associate' where relationshiptypeid= 18update la_partygroup_relationshiptype set isActive= false where relationshiptypeid= 17update la_partygroup_relationshiptype set isActive= false where relationshiptypeid= 19update la_partygroup_relationshiptype set isActive= false where relationshiptypeid= 20
Update la_ext_attributemaster set fieldname='Type of Right/Claim',fieldaliasname='Type of Right/Claim' where attributemasterid =23
Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid)Values('Small Business',1135,3)Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid)Values('Skilled Labor (carpentry, masonry, etc)',1135,4)Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid)Values('Professional/administrative/office',1135,5)Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid)Values('Public employee',1135,6)Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid)Values('Homekeeper',1135,7)Insert into la_ext_attributeoptions (optiontext,attributemasterid,parentid)Values('Other',1135,8)
CREATE OR REPLACE FUNCTION UpdateArea()RETURNS trigger AS$BODY$BEGIN  IF NEW.projectnameid=OLD.projectnameid THENupdate la_spatialunit_land set Area= (CAST(ST_Area(geometry) AS DOUBLE PRECISION)* CAST(111319 AS DOUBLE PRECISION)*CAST(111319 AS DOUBLE PRECISION))  Where LandID=OLD.LandID;END IF;RETURN NEW;END;$BODY$
LANGUAGE plpgsql VOLATILECOST 100;
CREATE TRIGGER tg_updatearea  AFTER UPDATE OF projectnameid  ON public.la_spatialunit_land  FOR EACH ROW  EXECUTE PROCEDURE public.updatearea();
update la_ext_rolemodulemapping set isactive='true' where rolemoduleid=8update la_spatialunit_land set Area= (CAST(ST_Area(geometry) AS DOUBLE PRECISION)* CAST(111319 AS DOUBLE PRECISION)*CAST(111319 AS DOUBLE PRECISION)) 
update la_ext_attributemaster set mandatory ='true' where attributemasterid=22;
INSERT INTO la_ext_process VALUES (9, 'Surrender of Mortgage', 'Surrender of Mortgage', true);
update la_ext_attributeoptions set parentid =3 where attributeoptionsid=1178;
update la_ext_attributeoptions set parentid =10 where attributeoptionsid=1179;
CREATE TABLE la_surrendermortgage (    mortgageid integer NOT NULL,    financialagencyid integer NOT NULL,    mortgagefrom date NOT NULL,    mortgageto date NOT NULL,    mortgageamount double precision NOT NULL,    isactive boolean DEFAULT true NOT NULL,    createdby integer NOT NULL,    createddate timestamp without time zone NOT NULL,    modifiedby integer,    modifieddate timestamp without time zone,    landid bigint,    ownerid bigint);
CREATE SEQUENCE la_surrendermortgage_mortgageid_seq    START WITH 1    INCREMENT BY 1    NO MINVALUE    NO MAXVALUE    CACHE 1; ALTER TABLE la_surrendermortgage ADD COLUMN surrenderreason character varying(250);
